...
List<S2Choice<String>> heroes = [
  S2Choice<String>(value: 'هر روز', title: 'ماهانه هر روز'),
  S2Choice<String>(value: 'هر روز + تردمیل', title: 'ماهانه هر روز بهمراه تردمیل'),
  S2Choice<String>(value: 'یک روز در میان', title:  'ماهانه یک روز در میان'),
  S2Choice<String>(value: 'یک روز در میان + تردمیل', title: 'ماهانه یک روز در میان بهمراه تردمیل'),

];

List<S2Choice<String>> fruits = [
  S2Choice<String>(value: 'برنامه تمرینی', title: 'برنامه تمرینی'),
  S2Choice<String>(value: 'برنامه غذایی', title: 'برنامه غذایی'),
];
